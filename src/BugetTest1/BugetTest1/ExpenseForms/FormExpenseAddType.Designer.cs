...
{
  partial class FormExpenseAddType
  {
    /// <summary>
    ...
    private void InitializeComponent()
    {
      ...
      this.groupBox1.Text = "Payment as";
      // 
      // cbAccount
      // 
      ...
      this.Name = "FormExpenseAddType";
      this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
      this.Text = "FormExpenseAddType";
      this.Load += new System.EventHandler(this.FormExpenseAddType_Load);
