...
namespace Common
{
  public class IncomeTypesObjectInfo
  {
    ...
    public IncomeTypesObjectInfo(short id, string name, bool useBankAccount, byte idAccount, bool isRegularPayment, byte frequency, short frequencyCounter, DateTime startDate, DateTime endDate)
    {
      _id = id;
      _name = name;
