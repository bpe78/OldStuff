...
{
  public static class ExpenseTypesDL
  {
    private static string _tableName = "ExpenseTypes";
    private static string _id = "ID";
    private static string _name = "Name";
    private static string _payFromAccount = "PayFromAccount";
    ...
    public static string PayFromAccount
    {
      get { return _payFromAccount; }
    }
