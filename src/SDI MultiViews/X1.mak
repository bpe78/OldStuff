...
"$(INTDIR)\X1View1.obj" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\X1.pch"


!ELSEIF  "$(CFG)" == "X1 - Win32 Debug"


"$(INTDIR)\X1View1.obj"	"$(INTDIR)\X1View1.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\X1.pch"
